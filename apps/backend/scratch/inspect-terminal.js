...
async function run() {
  try {
    ...
    const terminalPath = '/project/gsj9j6mz2rgs26h109lg7dxg/environment/mibkvgjurgjsm9urusgca6lu/application/fnjekbskvqux7jzy4rjs1yef/terminal';
    console.log(`Fetching terminal page: ${terminalPath}`);
    const html = await getPage(terminalPath, loginResult.cookies);
    
    fs.writeFileSync('terminal-page.html', html);
    console.log('Saved html to terminal-page.html');
