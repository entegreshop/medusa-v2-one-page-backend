...
async function run() {
  try {
    ...
    const envPath = '/project/gsj9j6mz2rgs26h109lg7dxg/environment/mibkvgjurgjsm9urusgca6lu/application/fnjekbskvqux7jzy4rjs1yef/environment-variables';
    console.log(`Fetching environment variables page...`);
